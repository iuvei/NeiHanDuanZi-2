...
import com.weibo.neihanduanzi.app.NeiHanDuanZiApplication;
...
public final class LogUtils {
    ...
    private static void printDeviceInfo(final String filePath) {
        ...
        int versionCode = 0;
        try {
            PackageInfo pi = NeiHanDuanZiApplication.getContext().getPackageManager().getPackageInfo(
                    NeiHanDuanZiApplication.getContext().getPackageName(), 0);
            if (pi != null) {
